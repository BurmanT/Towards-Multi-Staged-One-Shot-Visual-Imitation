...
class PickPlace(SingleArmEnv):
    ...
    def change_task_id(self, new_id):
        #print("In CHANGE ID FUNCTION")
        #print("object id, bin id, bin_bodyid BEFORE ")
        #print(self.object_id)
        #print(self.bin_id)
        #print(self.bin_bodyid)
        self.object_id = int(new_id//4)
        self.bin_id = new_id % 4
        names = ['bin_box_1', 'bin_box_2', 'bin_box_3', 'bin_box_4']
        self.bin_bodyid = self.sim.model.body_name2id(names[self.bin_id])
        #print("object id, bin id, bin_bodyid AFTER ")
        #print(self.object_id)
        #print(self.bin_id)
        #print(self.bin_bodyid)
